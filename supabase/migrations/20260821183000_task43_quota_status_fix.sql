-- Task 43 forward fix: status must report entitlement_active=false when the
-- account has no active entitlement. EXISTS avoids aggregate empty-row truthiness.
