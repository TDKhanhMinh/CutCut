...
const resources: Record<Locale, Record<string, TranslationValue>> = {
  en: {
    ...
    "editor.editTranscript": "Double click to edit",
    "editor.revertTranscript": "Revert transcript segment",
  ...
  vi: {
    ...
    "editor.editTranscript": "Nhấp đúp để chỉnh sửa",
    "editor.revertTranscript": "Hoàn tác segment transcript",
    "editor.revert": "Hoàn tác",
    "editor.remove": "Xóa",
    "editor.keep": "Giữ",
    "editor.skip": "Bỏ qua",
    "editor.cut": "Cắt",
